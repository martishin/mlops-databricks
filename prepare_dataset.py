...
df["date of reservation"] = df["date of reservation"].apply(
...
spark.sql(f"DROP TABLE IF EXISTS {catalog_name}.{schema_name}.extra_set")
spark.sql(f"DROP TABLE IF EXISTS {catalog_name}.{schema_name}.test_set")
spark.sql(f"DROP TABLE IF EXISTS {catalog_name}.{schema_name}.train_set")
...
spark.sql(
    f"UPDATE {catalog_name}.{schema_name}.train_set "
